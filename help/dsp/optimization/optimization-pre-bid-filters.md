...
| [!UICONTROL Viewability IAS] | Legt einen erforderlichen Mindestprozentsatz für die Sichtbarkeit fest, wobei historische Daten aus [!DNL IAS] verwendet werden. Sie bieten eine Impression an, wenn der angegebene Schwellenwert erreicht ist. | Dieser Filter funktioniert am besten, wenn mehr Daten über eine Integration auf Kampagnenebene abgerufen werden.[!DNL IAS]<br><br>Wenn die Kampagne für die Verwendung von  [!DNL IAS] Daten konfiguriert ist, empfiehlt es sich, diesen Filter mit dem Paketoptimierungsziel &quot;[!UICONTROL Lowest vCPM (IAS)]&quot;zu verwenden. Wenn die Integration nicht aktiviert ist, verwenden Sie diesen Filter mit dem Optimierungsziel &quot;[!UICONTROL Lowest CPM]&quot;. |
| [!UICONTROL Viewability Moat] | Legt einen erforderlichen Mindestprozentsatz für die Sichtbarkeit fest, wobei historische Daten aus [!DNL Moat] verwendet werden. Sie bieten eine Impression an, wenn der angegebene Schwellenwert erreicht ist. | Dieser Filter funktioniert am besten, wenn mehr Daten über eine Integration auf Kampagnenebene abgerufen werden.[!DNL Moat]<br><br>Wenn die Kampagne für die Verwendung von  [!DNL Moat] Daten konfiguriert ist, empfiehlt es sich, das Paketoptimierungsziel &quot;[!UICONTROL Lowest vCPM (Moat)]&quot;zu verwenden. Wenn die Integration nicht aktiviert ist, verwenden Sie diesen Filter mit dem Optimierungsziel &quot;[!UICONTROL Lowest CPM]&quot;. |
