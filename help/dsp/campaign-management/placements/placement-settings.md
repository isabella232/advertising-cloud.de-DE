...
>[!TIP]
>Verwenden Sie eine Benennungskonvention, die für Ihre Situation sinnvoll ist. Eine empfohlene Benennungskonvention ist &quot;*\&lt;Kampagnenname\>: \&lt;Werbeeinheit\>: \&lt;Dauer\>: \&lt;Targeting\>*.&quot;
...
**[!UICONTROL Details]:**  (schreibgeschützt) Der zutreffende Anzeigentyp, das Konto, das die Platzierung erstellt oder erstellt hat, und die übergeordnete Kampagne. Um weitere Details anzuzeigen, klicken Sie auf **[!UICONTROL Show more]**.
...
* *[!UICONTROL Set a fixed budget cap]:* Ermöglicht das Festlegen eines täglichen, wöchentlichen, monatlichen oder ganzjährigen Platzierungsbudgets. Geben Sie einen Wert und die Dauer ein (*[!UICONTROL All time]*, *[!UICONTROL Daily]*, *[!UICONTROL Weekly]*, *[!UICONTROL Monthly]*).

**[!UICONTROL Max Bid]:** Die maximale Zahlung für 1000 Impressionen.
...
**[!UICONTROL Pace on]:** Auf welchem Tempo basiert:
...
* *[!UICONTROL Even]:*  (Standardeinstellung) Bietet eine gleichmäßige Bereitstellung während jedes Fluges mit einer Zielvorgabe von 50 % des Versands in der ersten Hälfte des Fluges.

* *[!UICONTROL Frontload]:* Beschleunigt den Versand, sodass er zur Hälfte des Fluges vollständig ist (65-75 %).

* *[!UICONTROL Aggressive Frontload]:* Beschleunigt den Versand, sodass 75-85 % der gesamten Strecke vollständig sind.
...
1. Führen Sie einen der folgenden Schritte aus:
   * Ein- oder Ausschließen eines Landes, eines Bundesstaates, einer Stadt, DMA, eines Bundesgesetzbezirks oder eines Landbezirks
      ...
      1. Klicken Sie neben dem Speicherort auf *[!UICONTROL Include]* , um ihn als Ziel einzuschließen, oder auf *[!UICONTROL Exclude]* , um ihn als Ziel auszuschließen.
...
Fügen Sie eine Postleitzahl pro Zeile hinzu oder geben Sie mehrere Werte ein, die durch Kommas oder Tabs getrennt sind.
      1. Klicken Sie auf *[!UICONTROL Include All]* , um alle Orte als Ziele einzuschließen, oder auf *[!UICONTROL Exclude All]* , um alle Orte als Ziele auszuschließen.
   * Um einen Speicherort aus der Liste [!UICONTROL Included] oder [!UICONTROL Excluded] zu entfernen, klicken Sie neben der Position in der rechten Spalte auf **[!UICONTROL X]** .
...
**[!UICONTROL Inventory Sources]:** Inventarquellen, die als Ziele ein- oder ausgeschlossen werden sollen. Bei den meisten Platzierungstypen sind standardmäßig alle Inventartypen und alle Quellen für jeden Typ enthalten. Bei Platzierungen vom Typ [!DNL Roku] müssen Sie den Inventartyp und die Quellen angeben. Sie können aus den folgenden Lagerbestandsarten wählen:
...
* [!UICONTROL Private] |  [!UICONTROL Roku Private]: Ihre bestehenden privaten Angebote (oder bestehenden privaten  [!DNL Roku] Angebote für  [!DNL Roku] Platzierungen) für Herausgeber, die Sie in DSP eingerichtet haben. Sie können das öffentliche Inventar einbeziehen, aber nicht ausschließen.

   Sie können die Liste nach Keyword, Schlüssel, Deal-ID oder benutzerdefiniertem Tag durchsuchen.

* [!UICONTROL On Demand] |  [!UICONTROL Roku On Demand]: Alle  [Premium-, nicht garantierten  [!UICONTROL On Demand] Bestände](/help/dsp/inventory/on-demand-inventory-about.md)  (oder  [!UICONTROL On Demand] [!DNL] Roku-Angebote für  [!DNL Roku] Platzierungen), für die Sie sich angemeldet haben  [!DNL DSP]. Sie können [!UICONTROL On Demand] Inventar einbeziehen und ausschließen.
...
* So wählen Sie einen Inventartyp aus:
   ...
   1. (Optional) Ändern Sie die Quellen, um Folgendes einzuschließen:
      1. Klicken Sie auf ![Bearbeiten](/help/dsp/assets/edit.png).
      1. ([!UICONTROL Public] und [!UICONTROL On Demand] inventory) Klicken Sie auf *[!UICONTROL *View by Source]** oder **[!UICONTROL View by Feed]** , um zu ändern, wie die Quellen aufgelistet werden.
      ...
      1. Geben Sie die Quellen an, die ein- und ausgeschlossen werden sollen:
         ...
         * So schließen Sie [!UICONTROL Private] Quellen ein:
            * Um alle Bestände in einen Deal einzubeziehen, klicken Sie auf **[!UICONTROL Include all]** neben dem Namen des Deals.
         ...
         * Um eine [!UICONTROL Public]- oder [!UICONTROL On ]-Quelle auszuschließen, klicken Sie neben dem Quellnamen auf **[!UICONTROL Exclude]** .
   1. (Optional) Um eine CSV-Datei mit den Targeting-Informationen zum Download-Speicherort Ihres Browsers herunterzuladen, klicken Sie auf **[!UICONTROL Save & Export]**.
   1. Klicken **[!UICONTROL Save]**.

>[!TIP]
>
>Wenn Sie den Bestand von [!UICONTROL On Demand] abonniert haben, aber die Herausgeber oder Angebote nicht finden können, um die Zielgruppe festzulegen, überprüfen Sie den Status der Angebote. Weitere Informationen zu Statusangaben finden Sie unter [Info [!DNL On Demand] Premium Inventory](/help/dsp/inventory/on-demand-inventory-about.md).

**[!UICONTROL Exclude out-stream]:**  (Nur Videoplatzierungen) Schließt den abgehenden Traffic aus.
...
**[!UICONTROL Site tier]:** (Verfügbar, wenn  **[!UICONTROL Paste list of targeted sites]** ist  *[!UICONTROL Off]*) Die Qualität der Zielsites. Die Ebenen 1-3 sind alle markensicher und wurden vom DSP-Zuordnungsteam geprüft und genehmigt.

* *[!UICONTROL Tier 1]:* Premium-Sites und -Anwendungen, die national erkennbar sind.
* *[!UICONTROL Tier 2]:* Target-Ebene 1 sowie Qualitäts-Sites und -Anwendungen, die weniger weit als Tier 1 bekannt sind.
* *[!UICONTROL Tier 3]:* Zielebenen 1-2 sowie legitime und markensichere Websites und Anwendungen, die für eine Nische-Zielgruppe geeignet sind. Verwenden Sie Ebene 3 für Zielgruppen- oder Daten-Targeting-Käufe.
* *[!UICONTROL All Sites]:* Die Zielebenen 1-3 und der neue Bestand, der nicht geprüft oder kategorisiert wurde und den Sie für die Reichweite verwenden können.
...
**[!UICONTROL Site Categories]:** (Optional; verfügbar, wenn  **[!UICONTROL Paste list of targeted sites]** ist  *[!UICONTROL Off]*) Site-Kategorien innerhalb der ausgewählten Site-Ebenen, die entweder als Ziele ein- oder ausgeschlossen werden sollen (aber nicht beide). Wählen Sie aus den vertikalen Site-Listen, die Advertising Cloud basierend auf dem Site-Betreff zugeordnet hat:
...
1. (Optional) Um eine CSV-Datei mit den Targeting-Informationen zum Download-Speicherort Ihres Browsers herunterzuladen, klicken Sie auf **[!UICONTROL Export]**.
1. Klicken **[!UICONTROL Save]**.

**[!UICONTROL Exclude Sites]:** (Optional; verfügbar, wenn  **[!UICONTROL Paste list of targeted sites]** ist  *[!UICONTROL Off]*) Sites, die ausgeschlossen werden sollen. Sie können entweder nach Sites suchen und diese auswählen oder Domänennamen eingeben oder einfügen:
...
>[!NOTE]
>
>* Zusätzlich zu der Advertising Cloud DSP [global blockierten Site-Liste](/help/dsp/introduction/features/brand-safety-media-quality.md), die für Anzeigen als unsicher gilt, werden auch Blockierungslisten auf Kontoebene und Advertiser-Ebene angewendet.
...
**[!UICONTROL Sites]:**  (Verfügbar, wenn  **[!UICONTROL Paste list of targeted sites]** ist  *[!UICONTROL On]*) Zu Targeting bestimmte Sites. Sie können entweder nach Sites suchen und diese auswählen oder Domänennamen eingeben oder einfügen:
...
**[!UICONTROL Included Audiences]:** Alle Zielgruppensegmente für die Platzierung, einschließlich  [Drittanbietersegmenten, Erstanbietersegmenten, Segmenten der Adobe, benutzerdefinierten Segmenten und gespeicherten Zielgruppen](/help/dsp/audiences/audience-settings.md). Die gesamte und die aktive deduplizierte Zielgruppengröße für alle ausgewählten Segmente und gespeicherten Zielgruppen wird ebenfalls angezeigt. Sie können eine vorhandene Zielgruppe auswählen, eine neue Zielgruppe erstellen, die Sie später wiederverwenden können, oder bestimmte Zielgruppensegmente auswählen:

* Um eine vorhandene Zielgruppe auszuwählen, klicken Sie auf ![Wählen Sie](/help/dsp/assets/chevron-down.png) neben [!UICONTROL Included Audiences] und wählen Sie dann die Zielgruppe aus.
* Um eine neue Zielgruppe zu erstellen, klicken Sie auf ![Wählen Sie](/help/dsp/assets/chevron-down.png) neben [!UICONTROL Included Audiences] und wählen Sie dann **[!UICONTROL + Create Audience]** aus. Anweisungen finden Sie unter [Erstellen einer wiederverwendbaren Zielgruppe](/help/dsp/audiences/reusable-audience-create.md), beginnend mit Schritt 3.
...
**[!UICONTROL Excluded Audiences]:** Alle Zielgruppen, die für die Platzierung ausgeschlossen werden sollen, einschließlich Zielgruppen mit  [Drittanbietersegmenten, Erstanbietersegmenten, Segmenten der Adobe, benutzerdefinierten Segmenten und gespeicherten Zielgruppen](/help/dsp/audiences/audience-settings.md). Die gesamte und die aktive deduplizierte Zielgruppengröße für alle ausgeschlossenen Zielgruppen wird ebenfalls angezeigt. Sie können eine vorhandene Zielgruppe auswählen oder eine neue Zielgruppe erstellen, die Sie später wiederverwenden können:

* Um eine vorhandene Zielgruppe auszuwählen, klicken Sie auf ![Wählen Sie](/help/dsp/assets/chevron-down.png) neben [!UICONTROL Excluded Audiences] und wählen Sie dann die Zielgruppe aus.
* Um eine neue Zielgruppe zu erstellen, klicken Sie auf ![Wählen Sie](/help/dsp/assets/chevron-down.png) neben [!UICONTROL Excluded Audiences] und wählen Sie dann **+ Zielgruppe erstellen** aus. Anweisungen finden Sie unter [Erstellen einer wiederverwendbaren Zielgruppe](/help/dsp/audiences/reusable-audience-create.md), beginnend mit Schritt 3.

**[!UICONTROL Cross Device Targeting]:**  (Verfügbar, wenn Sie mindestens ein Segment oder eine Zielgruppe auswählen und die  [Kampagne für benutzerbasiertes geräteübergreifendes Targeting](/help/dsp/campaign-management/campaigns/campaign-settings.md) konfiguriert ist. Ermöglicht die Erweiterung des Targetings auf alle bekannten Geräte einer Person (entsprechend dem in den Kampagneneinstellungen angegebenen Gerätediagramm), auch auf Geräte, die nicht in den angegebenen Segmenten enthalten sind. Die Gebühren können je nach dem für die Kampagne angegebenen Diagramm gelten. Gerätediagrammdaten sind derzeit nur in Nordamerika verfügbar.

**[!UICONTROL Placement Cap]:** (Optional) Die Häufigkeit, mit der Anzeigen von der Platzierung für ein eindeutiges Gerät oder eine eindeutige Person bereitgestellt  [!UICONTROL Cross Device Level]werden (je nach spezifiziertem). Zu den Optionen gehören *[!UICONTROL Unlimited]* oder ein bestimmter Betrag pro Tag, Woche oder Monat.
...
**[!UICONTROL Secondary Cap]:** (Optional; verfügbar, wenn Sie eine numerische  [!UICONTROL Placement Cap]) Eine zusätzliche Begrenzung innerhalb der Grenzen der primären Platzierungsbegrenzung angeben. Wählen Sie die Anzahl der Impressionen und den Zeitraum aus (z. B. 3 pro 12 Stunden).
...
**[!UICONTROL Topic Targeting]:** (Optional; für Advertiser verfügbar, die mit  [!DNL Comscore] und - [!DNL Grapeshot] Segmenten konfiguriert wurden) Bestimmte Segmentnamen oder IDs aus  [!DNL Comscore] und  [!DNL Grapeshot] zur Aufnahme als Ziele. Für diese Funktion können zusätzliche Gebühren anfallen. Wenden Sie sich an Ihren Adobe-Kundenbetreuer, um diese Funktion zu aktivieren und Themensegmente einzurichten.
...
>
>* Richten Sie ein negatives Targeting innerhalb des Segments auf [!DNL Comscore] oder [!DNL Grapeshot] ein.
...
1. (Optional) Klicken Sie auf **[!UICONTROL Export]**, um eine CSV-Datei mit den Geräte-Targeting-Informationen zum Download-Speicherort Ihres Browsers herunterzuladen.
1. Klicken **[!UICONTROL Save]**.

**[!UICONTROL ISP Targeting]:** (Optional) Bestimmte Internet-Dienstanbieter (ISPs) können als Ziele entweder ein- oder ausschließen (aber nicht beides). So legen Sie das ISP-Targeting fest:
...
1. (Optional) Um eine CSV-Datei mit den ISP-Targeting-Informationen zum Download-Speicherort Ihres Browsers herunterzuladen, klicken Sie auf **[!UICONTROL Export]**.
1. Klicken **[!UICONTROL Save]**.

## [!UICONTROL Brand Safety and Media Targeting]

**[!UICONTROL Contextual filtering]:** Typen der anzuwendenden  [!DNL Comscore],  [!DNL DoubleVerify],  [!DNL Integral Ad Science] und  [!DNL Peer39] Kontextfilter. Die Standardeinstellungen auf Advertiser-Ebene werden für neue Platzierungen ausgewählt, Sie können jedoch die Einstellungen ändern:
...
* [!UICONTROL Peer 39]:
   ...
   * **Target-Sites mit folgenden Eigenschaften:**  (Optional) Standardmäßig eine oder mehrere Arten von Bestandsattributen als Ziel. Es können zusätzliche Gebühren erhoben werden.

* [!UICONTROL ComScore]:

   * **Blockieren Sie Sites mit folgenden Eigenschaften:**  (Optional) Ein oder mehrere Arten von Bestandsattributen, die standardmäßig blockiert werden sollen. Es können zusätzliche Gebühren erhoben werden.
...
* [!UICONTROL Integral Ad Science]:
   ...
   * **[!UICONTROL Block sites that are]:** (Optional) Ein Typ von verdächtigen Website- oder App-Aktivitäten, der dazu führt, dass DSP Anzeigen standardmäßig blockieren:  *[!UICONTROL None]* (die Standardeinstellung, die Anzeigen nicht aufgrund verdächtiger Aktivitäten blockiert),  *[!UICONTROL Suspicious Activity - High Risk]* oder  *[!UICONTROL Suspicious Activity - High or Moderate Risk]*. Es können zusätzliche Gebühren erhoben werden.

**[!UICONTROL Ads.txt filtering]:**

Welche Ebene von [Ads.txt](https://iabtechlab.com/ads-txt-about/) Prebid-Filterung zu verwenden ist, indem die Liste der autorisierten digitalen Verkäufer jedes Herausgebers genutzt wird. Die Standardeinstellung auf Advertiser-Ebene wird für neue Platzierungen ausgewählt, Sie können jedoch die Einstellungen ändern:
...
**[!UICONTROL DoubleVerify Authentic Brand Safety]:**  (Advertiser, die mit der  [!UICONTROL DoubleVerify Authentic Brand Safety] Option konfiguriert wurden) Aktiviert  [!DNL DoubleVerify Authentic Brand Safety], was Impressionen nach dem Angebot mithilfe der benutzerdefinierten Markensicherheitsregeln blockiert, die für die angegebene Segment-ID konfiguriert sind. DSP stellt Ihr Konto für die Verwendung der in den Advertiser-Einstellungen angegebenen Segment-ID in Rechnung.

## [!UICONTROL Tracking]

>[!NOTE]
>
>([!DNL Roku] Platzierungen) Drittanbieter-Tracking-Anbieter, die von [!DNL Roku] genehmigt wurden, sind [!DNL Acxiom], [!DNL comScore], [!DNL Data Plus Math], [!DNL Experian], [!DNL Factual], [!DNL Marketing Evolution], [!DNL Neustar], [!DNL Nielsen], [!DNL Nielsen Catalina Solutions], [!DNL NinthDecimal], a13/>, [!DNL Placed], [!DNL Polk] und [!DNL Research Now].[!DNL Kantar][!DNL Oracle]
...
1. Führen Sie einen der folgenden Schritte aus:
   ...
   * So erstellen Sie ein neues Pixel:
      ...
      1. Geben Sie die folgenden Informationen ein:
         ...
         * **[!UICONTROL Impression conversion window]:** Die Anzahl der Tage, nach denen eine Ad-Impression auftritt und in denen die Impression einer Konversion zugeordnet werden kann. Der Standardwert ist 30 Tage.
         * **[!UICONTROL Click conversion window]:** Die Anzahl der Tage nach einem Klick auf eine Anzeige, in denen der Klick einer Konversion zugeordnet werden kann. Der Standardwert ist 30 Tage.
      ...
      1. Implementieren Sie das Konversionspixel auf den relevanten Webseiten:
         ...
         1. Kopieren Sie die Werte in die Felder [!UICONTROL HTML Tag] und [!UICONTROL Flash Tag] , um sie dem Advertiser oder Website-Kontakt zur Verfügung zu stellen.
...
**[!UICONTROL 3rd-party Fees]:**  (Optional) Ein statischer Drittanbieter-Gebührensatz, der als nicht abrechnungsfähige Kosten pro Tausend Impressionen verfolgt werden soll. Die Standardeinstellung auf Paketebene wird bei neuen Platzierungen automatisch angewendet, sofern kein anderer Wert eingegeben wird.
