...
|-----------|-------|-----------|-----------|
| [!UICONTROL Dimension] | [!UICONTROL Ad] | [!UICONTROL Ad External ID] | Die vom externen Anzeigen-Server zugewiesene Anzeigen-ID. |
| [!UICONTROL Dimension] | [!UICONTROL Ad] | [!UICONTROL Ad ID] | Die eindeutige Kennung für die Anzeige in Advertising Cloud. |
| [!UICONTROL Dimension] | [!UICONTROL Ad] | [!UICONTROL Ad Name] | Der vom Benutzer zugewiesene Name der Anzeige. |
| [!UICONTROL Dimension] | [!UICONTROL Ad] | [!UICONTROL Ad Type] | Das Format der Anzeige. |
| [!UICONTROL Dimension] | [!UICONTROL Ad] | [!UICONTROL Status] | Die Classification der Anzeige, die vom Benutzer geändert oder durch die eingegebenen Daten gekennzeichnet wurde: *[!UICONTROL live]*, *[!UICONTROL scheduled]*, *[!UICONTROL completed]* oder *[!UICONTROL archived]*. |
| [!UICONTROL Dimension] | [!UICONTROL Advertiser] | [!UICONTROL Advertiser Name] | Der Name des Advertisers. |
| [!UICONTROL Dimension] | [!UICONTROL Campaign] | [!UICONTROL Budget] | Das vom Benutzer für die Kampagne zugewiesene Gesamtbudget. |
| [!UICONTROL Dimension] | [!UICONTROL Campaign] | [!UICONTROL Campaign End Date] | Das Enddatum für die Kampagne. |
| [!UICONTROL Dimension] | [!UICONTROL Campaign] | [!UICONTROL Campaign ID] | Die eindeutige Kennung für die Kampagne in Advertising Cloud. |
| [!UICONTROL Dimension] | [!UICONTROL Campaign] | [!UICONTROL Campaign Name] | Der vom Benutzer zugewiesene Kampagnenname. |
...
| [!UICONTROL Dimension] | [!UICONTROL Date/Time] | [!UICONTROL Time of Day] | Die Zeit bis zur Stunde, von 0 bis 23. |
| [!UICONTROL Dimension] | [!UICONTROL Date/Time] | [!UICONTROL Week (YYYY-MM-DD to YYYY-MM-DD)] | Der Datumsbereich für die entsprechende Woche, von Sonntag bis Samstag. Beispiel: 18.02.2021-2021-03-07. |
...
| [!UICONTROL Dimension] | [!UICONTROL Device] | [!UICONTROL Hardware] | Der Gerätetyp, auf dem die Anzeige angezeigt wurde (z. B. [!UICONTROL Set Top Box] oder [!UICONTROL Mobile Phone]). |
| [!UICONTROL Dimension] | [!UICONTROL Device] | [!UICONTROL Manufacturer] | Der Hersteller des Geräts, auf dem die Anzeige angezeigt wurde (z. B. [!UICONTROL Samsung], [!UICONTROL Lenovo] oder [!UICONTROL Apple]). |
...
| [!UICONTROL Dimension] | [!UICONTROL Device] | [!UICONTROL Operating System Vendor] | Der Anbieter des Betriebssystems, unter dem die Anzeige angezeigt wurde (z. B. [!UICONTROL Microsoft] oder [!UICONTROL Apple]). |
| [!UICONTROL Dimension] | [!UICONTROL Device] | [!UICONTROL Operating System Version] | Die Version des Betriebssystems, unter dem die Anzeige angezeigt wurde (z. B. [!UICONTROL Windows 10] oder [!UICONTROL iOS Mojave]) |
| [!UICONTROL Dimension] | [!UICONTROL Device] | [!UICONTROL Operating System] | Das Betriebssystem, unter dem die Anzeige angezeigt wurde (z. B. [!UICONTROL Apple iOS] oder [!UICONTROL Android]). |
...
| [!UICONTROL Dimension] | [!UICONTROL Pixel] | [!UICONTROL Conversion ID] | (Veraltet) Die Konversions-ID, die von DSP Legacy [!DNL TubeMogul]-Konversionsereignissen zugewiesen wurde. |
| [!UICONTROL Dimension] | [!UICONTROL Pixel] | [!UICONTROL Conversion Name] | (Veraltet) Der Konversionsname, der älteren [!DNL TubeMogul] Konversionsereignissen zugewiesen ist. |
...
| [!UICONTROL Metric] | [!UICONTROL Frequency] | [!UICONTROL App/Site Distinct Uniques] | Die Gesamtanzahl der Geräte, die nur in dieser App erreicht wurden. Ein Viewer, der einer Anzeige über mehrere Herausgeber hinweg ausgesetzt ist, ist in diesem Wert nicht enthalten. |
...
| [!UICONTROL Metric] | [!UICONTROL Frequency] | [!UICONTROL Estimated Average Frequency] | Die durchschnittliche Anzahl der Unique-Impressionen. Bei einigen Beständen geben Herausgeber keine Geräte-ID weiter, und diese Impressionen sind in diesem Wert nicht enthalten. Im [!UICONTROL Frequency (by App/Site)] -Bericht gibt es eine ähnliche Metrik, die jedoch nicht geschätzt wird. |
| [!UICONTROL Metric] | [!UICONTROL Frequency] | [!UICONTROL Estimated Impressions (Device/Browser)] | (Im [!UICONTROL Frequency (by Impression)]-Bericht enthalten) Die geschätzten Impressionen für eine bestimmte Frequenzaufschlüsselung. Advertising Cloud-Schätzungen basieren auf einer Stichprobe von Impressionen. Bei einigen Beständen geben Herausgeber keine Geräte-ID weiter, und diese Impressionen sind in diesem Wert nicht enthalten. Im [!UICONTROL Frequency (by App/Site)] -Bericht gibt es eine ähnliche Metrik, die jedoch nicht geschätzt wird. |
| [!UICONTROL Metric] | [!UICONTROL Frequency] | [!UICONTROL Estimated Uniques (Device/Browser)] | (Im [!UICONTROL Frequency (by Impression)]-Bericht enthalten) Die Anzahl der eindeutigen Browser oder Geräte, die für eine bestimmte Häufigkeit aufgezeichnet wurden. Advertising Cloud-Schätzungen basieren auf einer Stichprobe von Impressionen. Übergeben Sie für einige Bestände keine Geräte-ID, und diese Impressionen sind nicht in diesem Wert enthalten. Im [!UICONTROL Frequency (by App/Site)] -Bericht gibt es eine ähnliche Metrik, die jedoch nicht geschätzt wird. |
...
| [!UICONTROL Metric] |  | [!UICONTROL Performance] | [!UICONTROL Gross CPA] | Durchschnittliche Bruttokosten pro Akquise, berechnet von [!UICONTROL Gross Spend] / [!UICONTROL Custom Goal]. |
...
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Gross CPCV] | Die durchschnittlichen Kosten pro abgeschlossener Videoansicht, berechnet von [!UICONTROL Gross Spend] / [!UICONTROL 100% Completions]. |
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Gross CPM] | Durchschnittliche Kosten pro 1000 Impressionen, berechnet von [!UICONTROL Gross Spend] / [!UICONTROL Impressions] x 1000. |
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Gross CPV] | Die durchschnittlichen Kosten pro Videoansicht, berechnet von [!UICONTROL Gross Spend] / [!UICONTROL Views]. |
...
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Net CPC] | Die durchschnittlichen Nettokosten pro Anzeigenklick, berechnet von [!UICONTROL Net Spend] / [!UICONTROL Total Ad Clicks]. |
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Net CPCV] | Die durchschnittlichen Nettokosten pro abgeschlossener Videoansicht, berechnet von [!UICONTROL Net Spend] / [!UICONTROL 100% Completions] |
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Net CPM] | Die durchschnittlichen Nettokosten pro 1000 Impressionen, berechnet von [!UICONTROL Net Spend] / [!UICONTROL Impressions] x 1000. |
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Net CPV] | Die durchschnittlichen Nettokosten pro Videoansicht, berechnet von [!UICONTROL Net Spend] / [!UICONTROL Views]. |
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Total Data eCPM] | Die durchschnittlichen Nettodatenkosten pro 1000 Impressionen, berechnet von [!UICONTROL Net Spend (Data)] / [!UICONTROL Impressions] x 1000. |
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Total Media CPM] | Die durchschnittlichen Netto-Medienkosten pro 1000 Impressionen, berechnet von [!UICONTROL Net Spend (Media)] / [!UICONTROL Impressions] x 1000. |
| [!UICONTROL Metric] | [!UICONTROL Performance] | [!UICONTROL Total Other eCPM] | Die durchschnittlichen Nettokosten pro 1000 Impressionen für andere Gebühren, berechnet von [!UICONTROL Net Spend (Other)] / [!UICONTROL Impressions] x 1000. |
...
| [!UICONTROL Metric] | [!UICONTROL Spend] | [!UICONTROL Margin %] | (Wenn die Margenverwaltung aktiviert ist) Der Prozentsatz der Marge, der berechnet wird durch ([!UICONTROL Gross Spend] - [!UICONTROL Net Spend]) / [!UICONTROL Gross Spend]. |
...
| [!UICONTROL Metric] | [!UICONTROL Standard Metrics] | [!UICONTROL Banner and Overlay Clicks] | Die Anzahl der Klicks auf die Anzeigenüberlagerung und Banner. |
...
| [!UICONTROL Metric] | [!UICONTROL Viewability] | [!UICONTROL Viewability Rate (%)] | Der Prozentsatz sichtbarer Impressionen aus allen messbaren Impressionen, berechnet als [!UICONTROL Viewable Impressions] / [!UICONTROL Measurable Impressions]. |
...
| [!UICONTROL Custom Goals] | [Nach Advertiser in Berichtseinstellungen gruppiert] | [Advertiser-spezifisches benutzerspezifisches Ziel] | Die gewichtete Summe aller Konversionen, die im angegebenen [benutzerdefinierten Ziel](/help/dsp/optimization/custom-goal-about.md) enthalten sind. |
