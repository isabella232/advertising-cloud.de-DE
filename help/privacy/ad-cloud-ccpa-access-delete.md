...
1. Identifizieren Sie die Experience Cloud-ID Ihres Unternehmens und stellen Sie sicher, dass sie mit Ihren Advertising Cloud-Konten verknüpft ist.
...
* `"namespace": **imsOrgID**`
* `"value":` &lt;*Experience Cloud-ID-Wert Ihres Unternehmens*>
