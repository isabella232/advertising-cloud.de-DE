...
Alle in [!DNL Analytics] erstellten und in Experience Cloud veröffentlichten Segmente.
...
* [!UICONTROL ef_id_instances]: Die Häufigkeit, mit der ein  [!DNL Analytics] erfasst  [!UICONTROL EF ID]wurde.
